...
PICKS: list[Pick] = [
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "headline": "Liverpool à Anfield + BTTS — combo simple à cote value 2.10",
        "rationale": [
            "## 🎯 Le contexte",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.10 pour le combo Liverpool ML + BTTS. Probabilité estimée 55% → edge calculé +15.5%.",
            "Mise : 5€ — gain potentiel +5,50€ si validé.",
        ],
        "sources": [
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "headline": "Bautista pour gagner en 2 sets — cote 2.30 sur terre battue",
        "rationale": [
            "## 🎯 Le match",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.30 pour Bautista en 2 sets. Probabilité estimée 52% → edge calculé +19.6%.",
            "Mise : 5€ — gain potentiel +6,50€ si validé.",
        ],
        "sources": [
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "headline": "OKC win + Over 215.5 — combo cote value 2.50 G2 à domicile",
        "rationale": [
            "## 🎯 Le match",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.50 pour combo OKC ML + Over 215.5. Probabilité estimée 48% → edge calculé +20%.",
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "odds": 2.60,
        "model_probability": 0.48,
        "headline": "Paolini en 2 sets serrés — Under 21.5 jeux à cote 2.60",
        "rationale": [
            "## 🎯 Le match",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.60 pour Paolini + Under 21.5 jeux. Probabilité estimée 48% → edge calculé +24.8%.",
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "headline": "Wolves G3 home + Edwards en colère >28.5 pts — combo cote 2.30",
        "rationale": [
            "## 🎯 Le match",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.30 pour combo Wolves ML + Edwards Over 28.5 pts. Probabilité estimée 51% → edge calculé +17.3%.",
            "Mise : 5€ — gain potentiel +6,50€ si validé.",
        ],
        "sources": [
            "https://www.dimers.com/predictions/nba",
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "headline": "Báez vainqueur en 4 sets — pari niche sur dynamique de match prévue",
        "rationale": [
            "## 🎯 Le match",
            ...
            "## 🎰 Le pari",
            "Cote consensus marché 2.70 pour Báez en 4 sets exactement. Probabilité estimée 45% → edge calculé +21.5%.",
            ...
            "Mise : 5€ — gain potentiel +8,50€ si validé.",
        ],
        "sources": [
            "https://www.tennistonic.com/",
            "https://www.lastwordonsports.com/tennis/",
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "rationale": [
            ...
            "Stratégie combo 3 jambes : agréger 3 paris simples à cote modérée (1.24-1.30) pour atteindre une cote totale value (2.06) avec edge cumulé positif.",
            "Chaque jambe a une probabilité estimée individuelle ≥ 0.85 → produit ≈ 0.65 (proba combinée).",
            "## 📊 L'analyse des 3 jambes",
            ...
            "## 🎰 Le pari",
            "3 jambes à 1.28 × 1.30 × 1.24 = **cote totale 2.06** (consensus marché).",
            ...
            "Risque : si UNE seule jambe perd, tout le combo perd. Probabilité d'échec ≈ 34%.",
        ],
        "sources": [
            "https://www.tennistonic.com/",
            "https://www.lastwordonsports.com/tennis/",
        ...
        "result": {
            "score_home": "3/3",
            "score_away": "",
            "score_text": "3 jambes gagnées sur 3 — Osaka, Darderi, Cerundolo tous victorieux",
