...
PICKS: list[Pick] = [
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "result": {
            ...
            "summary": "Swiatek gagne facilement comme prévu MAIS le match fait 15 jeux totaux (6+1+6+2) → la jambe Under 14.5 du combo échoue.",
            "bet_outcome": "Pari perdu : Swiatek victorieuse (jambe 1 OK) mais 15 jeux totaux > 14.5 (jambe 2 raté) → combo perdu.",
        },
    },
    # ──────────────────────────────────────────────────────────────────
    ...
    # ──────────────────────────────────────────────────────────────────
    {
        ...
        "rationale": [
            ...
            "Combo 2 jambes (AB-4 v4.7 : pas de 3+ jambes) pour atteindre cote value 1.66 avec edge cumulé positif.",
            "## 📊 L'analyse des 2 jambes",
            ...
            "## 🎰 Le pari",
            "2 jambes à 1.29 × 1.29 = **cote totale 1.66** (consensus marché).",
            ...
            "Risque : si UNE seule jambe perd, tout le combo perd. Indépendance OK (courts différents : Simonne-Mathieu pour Bencic, Lenglen pour Rublev).",
        ],
        "sources": [
            "https://www.tennistonic.com/",
            "https://www.lastwordonsports.com/tennis/",
