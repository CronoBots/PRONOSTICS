...
TRANSLATIONS: dict[str, dict] = {
    ...
    "2026-05-29": {
        ...
        "score_text": "1 selection won out of 2 — Andreeva 2-0 OK, De Minaur -1.5 sets KO",
        "summary": "Combo lost: Mensik pulls off the upset and beats De Minaur 0-6 6-2 6-2 6-3 (De Minaur -1.5 leg missed). Andreeva beat Bouzkova 6-4 6-2 (2-0 leg OK) but to no effect.",
        "bet_outcome": "Bet lost: combo 1/2 (De Minaur beaten in 4 sets by Mensik). Net -5.00€.",
        "legs": [
            {
