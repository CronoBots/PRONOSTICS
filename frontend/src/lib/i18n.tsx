...
const fr: Dict = {
  ...
  "pricing.featureAnalysis": "14+ points d'analyse expliqués",
  "pricing.featureSources": "Sources web vérifiées",
...
const en: Dict = {
  ...
  "pricing.featureAnalysis": "14+ analysis points explained",
  "pricing.featureSources": "Verified web sources",
